...
/// @title Futarchy oracle contract - Allows creation of an oracle based on market behavior
...
contract FutarchyOracle is Oracle {
    ...
    /// @dev Allows setting of the oracle outcome based on the market with largest long position
    function setOutcome()
        public
    {
