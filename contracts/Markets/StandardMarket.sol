...
contract StandardMarket is Market {
    ...
    /// @dev Allows market funding with collateral tokens converting them into outcome tokens
    ...
    /// @dev Allows market creator to close the markets (transferring all remaining outcome tokens to the creator)
    function close()
        public
        isCreator
    ...
    /// @dev Allows purchase of outcome tokens from market maker
    ...
    /// @dev Allows sale of outcome tokens to market maker
    ...
    /// @dev Calculates market maker's fee
