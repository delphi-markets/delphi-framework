...
/// @title Campaign contract - Allows market crowdfunding
...
contract Campaign {
    ...
    /// @dev Allows contribution to required market funding
    ...
    /// @dev Allows market creation after successful funding
    ...
    /// @dev Allows fee withdrawal (market contract -> campaign contract)
    /// @return Fee amount
    ...
    /// @dev Allows fee withdrawal (campaign contract -> contributor)
    /// @return Fee amount
