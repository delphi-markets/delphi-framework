...
contract('MarketMaker', function(accounts) {
    ...
    it('test reprice outcome to 0 after many outcome sales to market maker', async () => {
        // Create event
        const numOutcomes = 2
    ...
    it('test reprice outcome to 1 after many outcome purchases from market maker', async () => {
