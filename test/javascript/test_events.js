...
contract('Event', function (accounts) {
    ...
    it('test buy/sell all outcomes', async () => {
        // Buy all outcomes
        const buyer = 0
    ...
    it('test buy/verify outcomes', async () => {
        // Buy all outcomes
        const buyer = 1
        const collateralTokenCount = 10
        await etherToken.deposit({ value: collateralTokenCount, from: accounts[buyer] })
    ...
    it('test buy/set/redeem outcomes for categorical event', async () => {
        // Buy all outcomes
        const buyer = 2
        const collateralTokenCount = 10
        await etherToken.deposit({ value: collateralTokenCount, from: accounts[buyer] })
    ...
    it('test buy/set/redeem outcomes for scalar event', async () => {
